...
public:
    ...
    BinOp(AST* left, const LToken& op, AST* right);
...
public:
    ...
    Num(const LToken& token, NUMTYPE ntype = INT);
...
public:
    ...
    Str(const LToken& token){ m_type = STR; m_token = token; m_value = m_token.value(); }
...
public:
    ...
    Array(const LToken& token, AST* array_size);
...
public:
    ...
    Assign(AST* left, const LToken& op, AST* right);
...
public:
    ...
    ClassStatement(string name, const LToken& token);
...
public:
    ...
    FunctionStatement(string name, const LToken& token);
...
public:
    ...
    FunctionExec(AST* statement, const LToken& token);
...
public:
    ...
    BuiltinStatement(const LToken& token);
...
public:
    ...
    Member(const LToken& token, MEMBERTYPE memtype = FUN);
...
public:
    ...
    BreakStatement(const LToken& token){ m_type = BREAK; m_token = token; }
};
...
public:
    ...
    ContinueStatement(const LToken& token){ m_type = CONTINUE; m_token = token; }
};
...
public:
    ...
    ReturnStatement(const LToken& token, AST* expr);
...
public:
    ...
    WhileCompound(const LToken& token, AST* expr);
...
public:
    ...
    ForCompound(const LToken& token, const vector<AST*>& init, AST* expr, const vector<AST*>& update);
...
public:
    ...
    IfCompound(const LToken& token, AST* expr);
...
public:
    ...
    IncludeStatement(const LToken& token){ m_type = INCLUDE; m_token = token; }
...
public:
    ...
    GlobalStatement(const LToken& token){ m_type = GLOBAL; m_token = token; }
